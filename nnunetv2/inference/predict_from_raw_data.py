...
from nnunetv2.utilities.cal_dice import dice
...
class nnUNetPredictor(object):
    ...
    def predict_from_data_iterator(self,
        ...
        with multiprocessing.get_context("spawn").Pool(num_processes_segmentation_export) as export_pool:
            ...
            r = []
            for idx,preprocessed in enumerate(data_iterator):
                num=800+idx
                print(num)
                if num!=911:
                    continue
    ...
    def _internal_predict_sliding_window_return_logits(self,
        ...
        for sl in tqdm(slicers, disable=not self.allow_tqdm):
            ...
            #print(workon.shape)#1,1,512,512
            prediction = self._internal_maybe_mirror_and_predict(workon)[0].to(results_device)
            #print(prediction.shape)1,2,512,512
...
def predict_entry_point():
    ...
    gt_folder=os.path.join(nnUNet_raw,maybe_convert_to_dataset_name(args.d),'gt')
    
    pre_folder=args.o
    d=dice(gt_folder,pre_folder)
    d.do()
